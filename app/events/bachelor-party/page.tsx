...
const BachelorParty = () => {
  return (
    <main className="">
      <Navbar />
      <Hero className="h-[780px] bg-black flex justify-center items-center w-screen transition duration-300 ease-in-out  hover:rounded-lg bg-[url('/jga.webp')] bg-cover bg-bottom bg-no-repeat">
        <div className="sm:pt-64">
          <h1 className="text-center text-[19px] leading-6 tracking-[5px] sm:px-0 px-5 uppercase text-white">
            Ein legendärer Tag
          </h1>
          <h2 className="text-center text-[37px] font-bold uppercase tracking-[10px] sm:pt-10 sm:px-0 px-5 leading-[80px] text-white">
            NextLevel JGA - <br />
      ...
      <SecondaryHero>
        ...
        <div className="grid grid-cols-3 sm:pt-[77px]">
      ...
      <section className="bg-black sm:px-[150px] sm:pt-[120px]">
        ...
        <h2 className="text-[42px] font-medium leading-[54px] uppercase tracking-[2px] pt-5">
          Sandbox VR
        </h2>
        ...
        <p className="pt-[28px] leading-5 text-[15px] text-white">
          ...
          Technologie und High-End VR-Brillen bringt <strong className="text-[#A6519A]">Sandbox VR</strong> eure Fantasie
      ...
      <section className="bg-mesh-gradient bg-top bg-fixed bg-no-repeat bg-cover sm:px-[150px] px-5 sm:pt-[90px] sm:pb-[53px]">
        <h1 className="text-lg font-medium tracking-[2.5px] uppercase leading-5">
          WIR HABEN NOCH MEHR ERLEBNISSE
        </h1>
        <h2 className="text-[41px] font-medium leading-[54px] uppercase tracking-[2px] pt-6">
      ...
      <section className="bg-black">
        ...
        <div className="sm:px-[150px] sm:pb-[76px] sm:pt-[120px]">
          <h1 className="text-lg uppercase font-medium leading-5 tracking-[2.5px] text-white">
            Das rundum-Paket
          </h1>
          <h2 className="uppercase text-[40px] text-white tracking-[2px] leading-[54px] pt-5 font-medium">
      ...
      <CorporateContact />
      <section className="sm:px-[150px] sm:pt-[70px] sm:pb-[109px]">
        ...
        <h1 className="text-aquagreen text-center uppercase tracking-[10px] leading-[30px] font-medium text-[22px] sm:pt-[89px]">
