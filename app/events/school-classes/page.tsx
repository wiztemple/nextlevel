...
const SchoolClasses = () => {
  ...
  return (
    <main className="break-words">
      <Navbar />
      <Hero className="sm:h-[681px] h-[545px] flex justify-center items-center w-screen transition duration-300 ease-in-out  bg-[url('/schulklassen.webp')] bg-cover bg-center bg-no-repeat">
      ...
      <section className="sm:px-[150px] px-5 sm:pt-[70px] pt-10 sm:pb-[109px] pb-[100px] bg-black">
        <div className="sm:grid grid-cols-3 hidden">
          ...
          <div className="flex justify-center">
            <div className="w-full">
              ...
              <span className="block text-center tracking-[5px] text-white uppercase leading-5 pt-6">
                TELEFON
              </span>
        ...
        <div className="sm:hidden block bg-black">
          <p className="uppercase leading-6 tracking-[2px] font-medium text-center pt-6 text-white">
          ...
          <div className="grid grid-cols-3 pt-8 items-center gap-5">
            ...
            <div className="flex justify-center">
              <div className="w-full">
                ...
                <span className="block text-center uppercase text-white leading-5 pt-6">
                  E-MAIL
                </span>
                <span className="block text-center text-white text-sm leading-5 pt-[11px]">
                zurich@sandboxvr.com
