  ...
  return (
    <main>
      ...
      <section className="bg-white sm:px-[165px] px-5 pt-[140px] pb-[122px] break-words">
        ...
        <div className="pt-6">
          <h2 className="sm:text-[32px] text-3xl font-medium leading-9 text-dark-3">
            1. Datenschutz auf einen Blick
          </h2>
          <h3 className="pt-2 text-dark-3 sm:text-[28px] text-2xl leading-8 font-medium">
            Allgemeine Hinweise
          </h3>
          <p className="text-gray-2 leading-6 pt-[11px]">
          ...
          <h3 className="pt-[22px] text-dark-3 text-[28px] leading-8 font-medium">
            Datenerfassung auf unserer Website
          </h3>
          <h4 className="text-gray-2 pt-[11px] leading-6 font-bold">
            Wer ist verantwortlich für die Datenerfassung auf dieser Website?
          </h4>
          <p className="text-gray-2 leading-6 pt-6">
            Die Datenverarbeitung auf dieser Website erfolgt durch den
            Websitebetreiber. Dessen Kontaktdaten können Sie dem Impressum
            dieser Website entnehmen.
          </p>
          <h4 className="text-gray-2 pt-6 leading-6 font-bold">
          ...
          <h2 className="sm:text-[32px] text-3xl font-medium leading-9 text-dark-3 pt-6">
          ...
          <p className="text-gray-2 leading-6 pt-2">
            Die verantwortliche Stelle für die Datenverarbeitung auf dieser
            Website ist:
          </p>
          <p className="text-gray-2 leading-6 pt-[22px]">
            Next Level Erlebnisse GmbH <br />
            Jahnstr. 14 <br />
            36304 Alsfeld
          </p>
          <p className="text-gray-2 leading-6 pt-6">
            Telefon: 06631 7882663 <br />
            E-Mail: hallo@nextlevel-erlebnisse.de
          </p>
          <p className="text-gray-2 leading-6 pt-6">
          ...
          <h2 className="text-[32px] font-medium leading-9 text-dark-3 pt-6">
            3. Datenerfassung auf unserer Website
          </h2>
          <h3 className="pt-2 text-dark-3 text-[28px] leading-8 font-medium">
            Cookies
          </h3>
          <p className="text-gray-2 leading-6 pt-[11px]">
          ...
          <ul className="list-disc pl-10 pt-6">
            <li className="text-gray-2 leading-6">
              Browsertyp und Browserversion
            </li>
            <li className="text-gray-2 leading-6">
              verwendetes Betriebssystem
            </li>
            <li className="text-gray-2 leading-6">Referrer URL</li>
            <li className="text-gray-2 leading-6">
              Hostname des zugreifenden Rechners
            </li>
            <li className="text-gray-2 leading-6">Uhrzeit der Serveranfrage</li>
            <li className="text-gray-2 leading-6">IP-Adresse</li>
          </ul>
          <p className="text-gray-2 leading-6 pt-[18px]">
          ...
          <p className="text-gray-2 leading-6 pt-6">
            ...
            Kommentare verfassen. Da wir Kommentare auf unserer Seite vor der
          ...
          <p className="text-gray-2 leading-6 pt-6">
            ...
            <a
              href="https://twitter.com/account/settings ändern."
              className="text-appblue"
              target="_blank"
            >
          ...
          <p className="text-gray-2 leading-6 pt-6">
            ...
            Ihr Google-Konto verwendet haben. Die Identität Ihres Google-
          ...
          <p className="text-gray-2 leading-6 pt-6">
            ...
            und auf Ihre Nutzung der Website bezogenen Daten (inkl. Ihrer IP-
            Adresse) an Google sowie die Verarbeitung dieser Daten durch Google
